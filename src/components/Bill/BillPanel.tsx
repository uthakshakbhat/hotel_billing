...
export function BillPanel({
  ...
  return (
    <div className={`bill-panel ${collapsed ? 'bp-collapsed' : ''}`}>
      <div className="bill-top" onClick={toggleCollapse}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 10 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
            <span className="bp-mini-total">₹{total.toFixed(2)}</span>
      ...
      <div id="bt-status" style={{ padding: '0 14px 12px', fontSize: 11, color: 'var(--text-muted)', textAlign: 'center' }}>
        {btConnected ? (
